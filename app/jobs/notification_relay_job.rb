class NotificationRelayJob < ApplicationJob
  ...
  def perform(notification)
    ...
    ActionCable.server.broadcast "notifications:#{notification.recipient_id}", html: html, html_to_notification_on_menu: html_to_notification_on_menu, notifications_not_read_count: notification.recipient.notifications.not_read.count
  end
end
